...
<%
    ...
    try {
        ...
        String query = "select ruangan_lab from penjadwalan where id_penjadwalan='" + id_penjadwalan + "'";
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="card">
                                                            <div class="card-body card-block">
                                                                <form action="../control/simpan_peminjaman.jsp" method="post">
                                                                   <input type="hidden" class="form-control" id="id_penjadwalan" name="id_penjadwalan" value="<%=id_penjadwalan%>">
                                                                    
                                                                    <div class="mb-3">
                                                                        <label for="nama" class="form-label">
                                                                            Username
                                                                        </label>
                                                                        <input type="text" class="form-control" id="username" name="username"  value="<%=(String) session.getAttribute("username")%>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="nama" class="form-label">
                                                                            Penanggung Jawab
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="ruangan_lab"
                                                                               name="ruangan_lab" value="<%=rs.getString("ruangan_lab")%>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="time" id="waktu_selesai" class="form-control" name="waktu_selesai"
                                                                               >
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="nama" class="form-label">
                                                                        ...
                                                                        <input type="hidden" class="form-control" name="status" id="status" value="diajukan">
                                                                    <div class="mb-3">
                                                                        <label for="nama" class="form-label">
                                                                            Level Peminjaman
                                                                        </label>
                                                                        <select class = "form-control" name="level_peminjaman" id="level_peminjaman">
                                                                            <option value=""></option>
