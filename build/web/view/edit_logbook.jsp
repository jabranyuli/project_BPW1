                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="card">
                                                            <div class="card-body card-block">
                                                                <form action="../control/edit_logbook.jsp" method="post">


                                                                    <div class="mb-3">
                                                                        <div class="mb-3">
                                                                            <label for="id_logbook" class="form-label">
                                                                                ID Logbook
                                                                            </label>
                                                                            <input class="form-control" type="text" id="id_logbook" name="id_logbook" value="<%=rs.getInt("id_logbook")%>" readonly/>
                                                                        </div>
                                                                        <label for="nama" class="form-label">
                                                                            Username
                                                                        </label>
                                                                        <input type="text" class="form-control" id="username" name="username" value="<%=rs.getString("username")%>" readonly/> 
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="id_peminjaman" class="form-label">
                                                                            ID Peminjaman
                                                                        </label>
                                                                        <input type="text" class="form-control" id="id_peminjaman" name="id_peminjaman" value="<%=rs.getString("id_peminjaman")%>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="no_pc" class="form-label">
                                                                            No PC
                                                                        </label>
                                                                        <input type="text" class="form-control" id="no_pc" name="no_pc" value="<%=rs.getString("no_pc")%>" >
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="keterangan" class="form-label">
                                                                            Keterangan
                                                                        </label>
                                                                        <input type="text" class="form-control" id="keterangan" name="keterangan" value="<%=rs.getString("keterangan")%>" >
                                                                    </div>
                                                                    <div class="mb-3">
